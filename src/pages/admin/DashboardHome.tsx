        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-gray-600 text-sm">Manage repair requests</div>
            </div>
          </div>
          <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-gray-600 text-sm">Monitor system health</div>
            </div>
          </div>
          <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-gray-600 text-sm">Automate admin tasks</div>
            </div>
          </div>
        </div>
      </Card>
