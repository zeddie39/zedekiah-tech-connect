    ...
    <section id="about" className="py-20 bg-secondary/50 relative">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-7xl mx-auto flex flex-wrap gap-8 justify-center">
          {/* What We Do Card */}
          <div className="bg-card rounded-2xl shadow-lg p-8 border border-border flex-1 min-w-[300px] max-w-sm mb-4">
            <h3 className="text-2xl font-orbitron font-bold text-primary mb-2 text-center">What We Do</h3>
            <ul className="list-disc pl-5 space-y-3 text-muted-foreground text-base md:text-lg">
          ...
          <div className="bg-card rounded-2xl shadow-lg p-8 border border-border flex-1 min-w-[300px] max-w-sm mb-4">
            ...
            <p className="text-muted-foreground text-base md:text-lg mb-4 text-center">
          ...
          <div className="bg-card rounded-2xl shadow-lg p-8 border border-border flex-1 min-w-[300px] max-w-sm mb-4">
            ...
            <ul className="list-disc pl-5 space-y-3 text-muted-foreground text-base md:text-lg text-left">
        ...
        <div className="max-w-7xl mx-auto mt-12 flex flex-col md:flex-row gap-8 items-stretch">
          <div className="flex-1 flex flex-col justify-center mb-8 md:mb-0">
            <div className="bg-primary/90 rounded-xl p-6 text-primary-foreground text-center shadow-lg border border-accent/30">
