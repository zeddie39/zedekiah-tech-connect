...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#160e2e] dark:bg-card text-white dark:text-foreground py-8 sm:py-12 dark:border-t dark:border-border">
          ...
          <div>
            ...
            <ul className="space-y-1 sm:space-y-2">
              ...
              <li>
                <Link 
                  to="/careers"
                  className="text-gray-300 hover:text-accent transition-colors duration-200 text-xs sm:text-base font-medium"
                >
