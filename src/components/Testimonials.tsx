...
const testimonials = [
  ...
  {
    quote: "Expert advice and friendly staff. Solved my networking issues in no time.",
    author: "Wanjiru Njeri",
  },
  {
    quote: "Affordable and top-notch maintenance for our office equipment.",
  ...
  {
    quote: "Quick turnaround and good communication. Highly recommended.",
    author: "Abdi Yusuf",
  },
];
  ...
  <section className="py-16 px-4 bg-muted text-center">
    ...
    <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
      {testimonials.map((t, i) => (
        <blockquote
          key={t.author}
          className="glass-card w-full flex flex-col justify-center items-start relative p-4 sm:p-5 md:p-6 rounded-xl border-l-4 border-accent shadow-md animate-fade-in hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
          style={{
        ...
        >
          ...
          <p className="italic text-base md:text-lg mb-3 text-foreground/80">{`"${t.quote}"`}</p>
